...
map("n", "<A-n>", "<Cmd>NvimTmuxNavigateLeft<CR>", { silent = true })
map("n", "<A-e>", "<Cmd>NvimTmuxNavigateDown<CR>", { silent = true })
map("n", "<A-u>", "<Cmd>NvimTmuxNavigateUp<CR>", { silent = true })
map("n", "<A-i>", "<Cmd>NvimTmuxNavigateRight<CR>", { silent = true })
